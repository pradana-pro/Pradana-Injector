...
<body class="box_script" style="text-align:center">
	<center>
		...
		<img src="img/pradanainjector.png" width: 100%></a>
	</center>
    <form method="post">
		<center>
			<table align="center"><tr><td class="col-butt">
				...
				<input type="submit" name="button4" class="btn geser" id"https://sociabuzz.com/pradanapro/tribe/"
					value="Donasi"/>
				</td></tr>
			</table>
		</center>
